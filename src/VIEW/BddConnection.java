 ...
 * @author ritch
 */
public class BddConnection extends javax.swing.JFrame {

    /**
     * Creates new form BddConnection
     */
    ...
    private void initComponents() {
        ...
        jPasswordField1.setText("E.T.2000");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Main.password = jPasswordField1.getText();
        ...
        try {
            ...
            EmployeeCustomer choose = new EmployeeCustomer();

            choose.setVisible(true);

        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null,"WRONG ID/PASSWORD OR DATABASE NOT CONNECTED");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BddConnection.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BddConnection().setVisible(true);
            }
        });
    }
