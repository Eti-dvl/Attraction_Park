...
public class EmployeeCustomer extends javax.swing.JFrame {
    ...
    public static boolean customerEmployee;  
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        LogIn log = new LogIn();
        log.setVisible(true);
        customerEmployee = false;    //if false its a employee
    }//GEN-LAST:event_jButton1ActionPerformed

    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        dispose();
        Application cust = new Application();
        cust.setVisible(true);
        customerEmployee = true;    //if true it's a customer
